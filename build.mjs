...
function normalizeMedia(value = '') {
  ...
  const map = new Map([
    ['GAME', '게임'], ['게임', '게임'],
    ['ANIME', '애니'], ['애니', '애니'], ['애니메이션', '애니'], ['CARTOON', '애니'], ['ANIMATION', '애니'],
    ['WEBTOON', '만화'], ['웹툰', '만화'], ['MANGA', '만화'], ['만화', '만화'],
    ['NOVEL', '소설'], ['WEB NOVEL', '소설'], ['WEBNOVEL', '소설'], ['소설', '소설'], ['웹소설', '소설'], ['희곡', '소설'], ['단편집', '소설'], ['단편소설', '소설'], ['장편소설', '소설'],
    ['MANGA', '만화'], ['COMIC', '만화'], ['만화', '만화'],
    ['MOVIE', '영화'], ['FILM', '영화'], ['영화', '영화'], ['MOVIES', '영화'],
    ['DRAMA', '드라마'], ['드라마', '드라마'], ['TV', '드라마'], ['미드', '드라마'], ['한드', '드라마'], ['중드', '드라마'], ['일드', '드라마'], 
